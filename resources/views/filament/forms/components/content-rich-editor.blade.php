            ...
            >
                ...
                >
                    <div class="flex gap-x-3 overflow-x-auto">
                        ...
                        <x-filament-forms::rich-editor.toolbar.group
                            data-trix-button-group="align-tools"
                        >
                            <x-filament-forms::rich-editor.toolbar.button
                                data-trix-attribute="textAlignRight"
                                title="محاذاة لليمين"
                                tabindex="-1"
                                class="!min-w-[2rem] px-2 text-xs"
                            >
                                يمين
                            </x-filament-forms::rich-editor.toolbar.button>
                            ...
                            <x-filament-forms::rich-editor.toolbar.button
                                data-trix-attribute="textAlignLeft"
                                title="محاذاة لليسار"
                                tabindex="-1"
                                class="!min-w-[2rem] px-2 text-xs"
                            >
                            ...
                            <x-filament-forms::rich-editor.toolbar.button
                                data-trix-attribute="textAlignJustify"
                                title="ضبط النص"
                                tabindex="-1"
                                class="!min-w-[2rem] px-2 text-xs"
                            >
